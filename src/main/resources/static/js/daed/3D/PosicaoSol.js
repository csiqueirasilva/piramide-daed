...
//    skyBoxCompleto.add(skyBoxBot);
    ...
    var objetoSol = ON_DAED["3D"].criarSol(observacaoFirmamento.getRaioHorizonte() / (3.84 * 1.6), observacaoFirmamento.getFirmamento());
...
//        skyBoxGeoBot.colorsNeedUpdate = true;
    ...
    observacaoFirmamento.addUpdateCommand(observacaoFirmamento.OBSERVACAO_EQUATORIAL, function (e, fuso) {
        var position = e.data;
        o.posicaoSolar(position.sun.rightAscension, position.sun.declination, position.sun.R / 30);
