...
//                }
        ...
        var lua = new THREE.Mesh(
                ...
                new THREE.MeshPhongMaterial({
                    map: THREE.ImageUtils.loadTexture("lib/on-daed-js/imgs/texturas/lua/lua.jpg")
                })
                );
        ...
        var mercurio = new THREE.Mesh(
                ...
                new THREE.MeshBasicMaterial({
                    map: THREE.ImageUtils.loadTexture("lib/on-daed-js/imgs/texturas/planetas/mercury.jpg"),
                })
                );
        ...
        var venus = new THREE.Mesh(
                ...
                new THREE.MeshBasicMaterial({
                    map: THREE.ImageUtils.loadTexture("lib/on-daed-js/imgs/texturas/planetas/venus.jpg")
                })
                );
        ...
        var mars = new THREE.Mesh(
                ...
                new THREE.MeshBasicMaterial({
                    map: THREE.ImageUtils.loadTexture("lib/on-daed-js/imgs/texturas/planetas/mars.jpg")
                })
                );
        ...
        var saturn = new THREE.Mesh(
                ...
                new THREE.MeshBasicMaterial({
                    map: THREE.ImageUtils.loadTexture("lib/on-daed-js/imgs/texturas/planetas/saturn.jpg")
                })
                );
        ...
        var uranus = new THREE.Mesh(
                ...
                new THREE.MeshBasicMaterial({
                    map: THREE.ImageUtils.loadTexture("lib/on-daed-js/imgs/texturas/planetas/uranus.jpg")
                })
                );
        ...
        var neptune = new THREE.Mesh(
                ...
                new THREE.MeshBasicMaterial({
                    map: THREE.ImageUtils.loadTexture("lib/on-daed-js/imgs/texturas/planetas/neptune.jpg")
                })
                );
