ON_DAED["3D"].ObservacaoFirmamento = function (scene, camera, parent) {
    ...
    ON_DAED['3D'].register(scene, firmamentoB, function () {
        ...
        if (observacaoHorizontal) {
            ...
            firmamentoL.rotation.y = (ts.apparentSiderealTime * Math.PI * 2) / 24 + longitudeUsuario;
            firmamentoB.rotation.z = Math.PI / 2 + latitudeUsuario;
        } else {
            firmamentoL.rotation.y = firmamentoB.rotation.z = 0;
        }
    ...
    $(document).ready(function () {
        ...
        function atualizacaoAutomatica() {
            ...
            if (atualizacaoInterval === null) {
                ...
                atualizacaoInterval = window.setInterval(function () {
