ON_DAED["3D"].RelogioSolar = function (scene, camera) {
    ...
    var texturaSunDial = THREE.ImageUtils.loadTexture('lib/on-daed-js/imgs/texturas/texturas/marble.jpg');
    ...
    var terra = new THREE.Mesh(
            ...
            new THREE.MeshPhongMaterial({
                ...
                bumpMap: THREE.ImageUtils.loadTexture('lib/on-daed-js/imgs/texturas/terra/bump.jpg'),
                bumpScale: 1,
                shininess: 0.5,
                specularMap: THREE.ImageUtils.loadTexture('lib/on-daed-js/imgs/texturas/terra/specular.jpg')
            }));
